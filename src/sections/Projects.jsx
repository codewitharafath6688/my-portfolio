...
const Projects = () => {
  ...
  return (
    <Section
      ...
      className="bg-slate-100/50 dark:bg-slate-900/30"
    >
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {projectsData.map((project) => (
          ...
          >
            <div className="aspect-video overflow-hidden bg-white dark:bg-slate-900 flex items-center justify-center">
              <img
                src={project.image}
                alt={project.title}
            ...
            <div className="p-8">
              <div className="flex flex-wrap gap-2 mb-4">
                {project.tags.slice(0, 2).map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 bg-blue-50 dark:bg-blue-900/20 text-blue-600 text-xs font-bold rounded-full uppercase tracking-wider"
                  >
                    {tag}
                  </span>
                ))}
      ...
      <AnimatePresence>
        {selectedProject && (
          ...
          >
            ...
            >
              <button
                onClick={() => setSelectedProject(null)} // close on cross click
              ...
              <div className="p-8 md:p-12">
                ...
                <div className="flex flex-wrap gap-2 mb-8">
                  {selectedProject.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-4 py-1.5 bg-slate-100 dark:bg-slate-800 text-xs font-bold rounded-full uppercase tracking-wider"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex gap-4 mt-12">
                  <a
                    ...
                    target="_blank"
                    className="px-8 py-3 bg-blue-600 text-white rounded-full font-bold flex items-center gap-2"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    className="px-8 py-3 bg-slate-200 dark:bg-slate-800 rounded-full font-bold flex items-center gap-2"
                  >
